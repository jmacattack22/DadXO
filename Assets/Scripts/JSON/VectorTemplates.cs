...
public static partial class JSONTemplates {
	...
	public static Vector2Int ToVector2Int(JSONObject obj)
	{
		int x = obj["x"] ? (int)obj["x"].i : 0;
		int y = obj["y"] ? (int)obj["y"].i : 0;
	...
	public static JSONObject FromVector2Int(Vector2Int v)
	{
		JSONObject vdata = JSONObject.obj;
		if (v.x != 0) vdata.AddField("x", v.x);
		if (v.y != 0) vdata.AddField("y", v.y);
